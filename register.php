			...
			<div id="inputContainer">
				...
				<form id="registerForm" action="register.php" method="POST">
					...
					<p>
						...
						<input id="username" name="username" type="text" placeholder="Seung Jae" value="<?php getInputValue('username') ?>" required>
					</p>

					<p>
						<?php echo $account->getError(Constants::$firstNameCharacters); ?>
						<label for="firstName">First name</label>
						<input id="firstName" name="firstName" type="text" placeholder="Jae" value="<?php getInputValue('firstName')?>" required>
					</p>

					<p>
						<?php echo $account->getError(Constants::$lastNameCharacters); ?>
						<label for="lastName">Last name</label>
						<input id="lastName" name="lastName" type="text" placeholder="Choi" value="<?php getInputValue('lastName')?>" required>
					</p>
